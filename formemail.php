...
<body>
    ...
    <div class="d-flex justify-content-center">
        <div class="col-sm-6  ">
            <form action="email.php" class="row g-3 m-5 p-2" method="POST">
                <!--nombre y apellido-->
                ...
                <div class="col-md-12 col-sm-12 col-lg-12 p-1">
                    <input type="text" class="form-control" placeholder="Mensaje" name=cuerpo>
                </div>
                <!--Botones-->
                <div class="col-md-6 col-sm-6 col-lg-6 p-5">
